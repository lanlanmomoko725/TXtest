    ...
    <div className="min-h-screen">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-2 text-sm text-slate-500 mb-4">
          ...
          <span>/</span>
          <span className="text-slate-900 font-medium">标签</span>
        </div>
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2">
              <Hash className="h-6 w-6 text-sky-600" />
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20">
            <Hash className="h-16 w-16 mx-auto mb-4 text-slate-300" />
            <h3 className="text-lg font-medium text-slate-700 mb-2">暂无内容</h3>
            <p className="text-slate-500">还没有包含 #{decodedTag}# 标签的帖子或文章</p>
          </div>
        )}
      </div>
    </div>
