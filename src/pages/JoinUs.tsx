...
import { ArrowLeft, Handshake, UsersRound } from "lucide-react";
    ...
    <div className="min-h-screen">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center py-20 rounded-2xl border border-border/60 bg-card">
          <UsersRound className="h-16 w-16 mx-auto mb-4 text-muted-foreground/40" />
          <h2 className="text-lg font-medium text-foreground/80 mb-2">暂无内容</h2>
          <p className="text-muted-foreground">加入我们板块正在准备中。</p>
        </div>
      </div>
    </div>
  );
